...
struct IntArray {
    elements: felt*,
    word_len: felt,  // number of 64-bit words
    byte_len: felt,  // total number of bytes
}
...
func swap_endian{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(input: felt, size: felt) -> (
    output: felt
) {
    alloc_locals;
